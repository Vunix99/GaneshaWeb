...
<body>
    ...
    <section id="content">
        <form class="postingan" id="resepForm" method="post" action="">
            <div class="card-artikel">
            ...
            <div class="card-artikel">
                <div class="artikel-title">
                    <input type="number" min="1" id="jumlah_kalori_resep" name="jumlah_kalori_resep" placeholder="Jumlah Kalori Resep" required />
                </div>
            </div>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $jumlah_kalori_resep = $_POST['jumlah_kalori_resep'];
        $gambar_resep = $_POST['gambar_resep'];
        $deskripsi = $_POST['deskripsi'];
        $id_resep = $_POST['id_resep'];

        // Buat URL endpoint
        $endpoint = 'https://asia-south1.gcp.data.mongodb-api.com/app/application-0-dlgbn/endpoint/insertResep';
